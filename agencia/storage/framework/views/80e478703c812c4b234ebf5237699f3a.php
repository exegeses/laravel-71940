...
<?php endif; ?>
        ...
        <?php $__currentLoopData = $regiones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $region): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr class="hover:bg-gray-950 odd:bg-gray-700">
                    <td class="py-2 px-3"><?php echo e($region->idRegion); ?></td>
                    <td class="py-2 px-3 text-xl"><?php echo e($region->nombre); ?></td>
                    <td class="text-right py-2 px-3">
                        <a href="/region/edit/<?php echo e($region->idRegion); ?>"
                           class="inline-flex items-center px-1 py-1 px-3 border-2 rounded-md border-green-400 dark:border-green-600 text-sm font-medium leading-5 text-gray-900 dark:text-green-400 hover:bg-green-900 focus:outline-none focus:border-green-700 transition duration-150 ease-in-out"
                        >&nbsp; Modificar &nbsp;</a>
                        <a href="/region/delete/<?php echo e($region->idRegion); ?>"
                           class="inline-flex items-center px-1 py-1 px-3 border-2 rounded-md border-green-400 dark:border-green-600 text-sm font-medium leading-5 text-gray-900 dark:text-green-400 hover:bg-green-900 focus:outline-none focus:border-green-700 transition duration-150 ease-in-out"
                        >&nbsp; Eliminar &nbsp;</a>
                    </td>
                </tr>
...
<?php /**PATH /Users/marcos/Documents/Cursos/Laravel/laravel-71940/agencia/resources/views/regiones.blade.php ENDPATH**/ ?>